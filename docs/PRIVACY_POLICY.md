...
We do not collect any personal data. This project runs locally and does not transmit data to any external service.
...
No payments are processed. Payment processing is handled by N/A and we do not store full payment card details.
...
| N/A | Payment processing | Payment details (PCI-DSS compliant) |
